...
On the main page of the [Hibridon GitHub repository](https://github.com/hibridon/hibridon/), the badges at the top of the build instructions allow you to check if the last bunch of tests were successful (passing):
...
Two tests suites are executed for the continuous integration:
