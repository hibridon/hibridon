...
- ienerg:  The cardinal value of the [energy](Energy) to which the S matrices refer. If ienerg = 2, say, then the second energy S matrices [{jobnam1}2.smt and {jobnam2}2.smt] are compared
