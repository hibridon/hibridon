...
For collisions of molecules with surfaces, the orbital angular momentum is zero, and does not couple with the molecular rotational angular momentum. Thus, if FLAGSU = .TRUE., you must also set [`CSFLAG`](../param/csflag.md) = .TRUE., [`JTOT1`](../param/jtot1.md) = 0, and [`JTOT2`](../param/jtot2.md) = 0. Otherwise the program will abort with a diagnostic message.
