...
If PHOTOF = .FALSE., then inelastic scattering [boundary conditions](../Boundary.md) are assumed.
If PHOTOF = .TRUE., then photodissociation [boundary conditions](../Boundary.md) are assumed.