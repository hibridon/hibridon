...
The parameter NIOUT sets the length of the array [`INDOUT`](../com/indout.md) of quantum number(s) (in addition to the array [`JOUT`](../com/jout.md)) for which
...
The length of the array INDOUT is given by the absolute value of NIOUT. If [`WRSMAT`](./wrsmat.md) is.TRUE., then
...
Changing or setting the value of NIOUT can be done only by setting the [`INDOUT`](../com/indout.md) parameter as follows:
```
