...
Subsequent calculation of the wavefunction is invoked by the command [`PSI`](../com/psi.md). Subsequent calculation of the incoming and outgoing fluxes is controlled by the command [`FLUX`](../com/flux.md). 
