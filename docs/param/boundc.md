...
The Hibridon code can determine energies and eigenvectors of weakly-bound states as well as scattering and photodissociation cross sections. This involves only a slight change in the [methodology](../Bound-States.md). To determine bound-state energies, set:
...
This set of functions is defined by several of the Hibridon input [parameters](../Parameters.md), as follows:
...
- [`NUMIN`](./numin.md), (if [`FLAGHF`](./flaghf.md) = .FALSE.)
- [`NUMIN`](./numin.md)+0.5, (if [`FLAGHF`](./flaghf.md) = .TRUE.)
