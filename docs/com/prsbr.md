...
With this module, the pressure broadening cross section for an isolated spectral line, or collisionally coupled lines, can be computed. The kinetic energies for the initial and final levels should be the same in the two scattering calculations. In addition, [`JTOT1`](../param/jtot1.md) and [`JTOT2`](../param/jtot2.md) should be the same for both calculations.
