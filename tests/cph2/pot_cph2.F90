...
!-----------------------------------------------------------------------
!
!     potentiel RKHS pour l'Ètat A1 de H2 + C+ en gÈometrie perpendiculaire
!     distance en bohr, Ènergie en cm-1
!     18/02/13 nouveau fit.
!
...
!-----------------------------------------------------------------------
!
!     potentiel RKHS pour l'etat B1 de H2 + C+ en geometrie perpendiculaire
!     distance en bohr, energie en cm-1
!     18/02/13 nouveau fit.
!
implicit double precision(a-h,o-z)
...
!-----------------------------------------------------------------------
!
!     potentiel RKHS pour l'etat B2 de H2 + C+ en geometrie perpendiculaire
!     distance en bohr, energie en cm-1
!     18/02/13 nouveau fit.
!
implicit double precision(a-h,o-z)
...
!-----------------------------------------------------------------------
!
!     Calcul de la fonction "reciprocal power" au point "y"
!
implicit double precision(a-h,o-z)
dimension xgr(nx),coef(nx)
...
!-----------------------------------------------------------------------
!
!     potentiel RKHS pour l'etat Sigma de H2 + C+ en gÈomÈtrie linÈaire
!     distance en bohr, Ènergie en cm-1
!     18/02/13 nouveau fit.
!
implicit double precision(a-h,o-z)
...
!-----------------------------------------------------------------------
!
!     potentiel RKHS pour l'Ètat Pi de H2 + C+ en gÈometrie LinÈaire
!     distance en bohr, Ènergie en cm-1
!     18/02/13 nouveau fit.
!
implicit double precision(a-h,o-z)
...
use mod_cph2, only: fpot_per1, fpot_per2, fpot_per3, fpot_lin1, fpot_lin2
implicit double precision (a-h,o-z)
...
vv0=vv0*econv
!      write(*,*) vv0,vvl(1),vvl(2),vvl(3),vvl(4)
end
