...
! output:interaction  energy in kcal/mol
!       ***********************************
!       *       JACEK KLOS                *
!       * Department of Chemistry         *
!       * Warsaw University               *
!       * Pasteura 1 Warsaw               *
!       * e-mail:jakl@tiger.chem.uw.edu.pl*
!       ***********************************
implicit double precision (a-h,o-z)
...
! Associated Legendre polynomial factors (calculated from Legendre polynomials
!     in this case)
...
! (This section copied from slow version; see nhar12.f)
...
!BELOW IS FUNCTION FOR vVdif (V_{2})
function vvdif(rr,y)
! Code for Vdif at MP4 level for ArOH: Vdif= (A"-A')*1/2
!  y = cos(theta) theta=0 for Ar--HO
! units:
! input: rr in bohr, y = cos(theta) theta=0 for Ar--HO
! output in kcal/mol
!       ***********************************
!       *       JACEK KLOS                *
!       * Department of Chemistry         *
