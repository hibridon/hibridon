!     ----------------------------------------------------------------- 
!     pot routine for the  C2H-H2 PES computed by Dagdigian (2017)
!
!     points fit with LAmax = 12, LBmax = 6
!
!     to be used with the 2Sigma-1Sigma basis routine
!     data file used:  pot_c2hh2_12_6.dat
!
...
!     current revision:  29-aug-2017 (p. dagdigian)
!     ------------------------------------------------------------------
...
!     ----------------------------------------------------------------- 
!     loapot subroutine loads pot parameters for C2H-H2 interaction
!     ----------------------------------------------------------------- 
