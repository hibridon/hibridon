...
The only way to print out the list of channels on your terminal screen is to set the flag [`BASTST`](BASTST) = .TRUE., in which case the job will cease after the list of channels is printed, and await a new command.
