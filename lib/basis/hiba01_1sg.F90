module mod_ba1sg
    ...
    contains
    procedure, nopass :: compute_angular_coupling
...
subroutine compute_angular_coupling(j, l, is, jhold, ehold, ishold, nlevel, nlevop, sc1, sc2, sc3, sc4, rcut, jtot, &
    ...
    real(8) :: rcut
    call ba1sg (j, l, is, jhold, ehold, ishold, nlevel, nlevop, &
    sc1, sc2, sc3, sc4, rcut, jtot, flaghf, flagsu, &
    csflag, clist, bastst, ihomo, nu, numin, jlpar, &
    n, nmax, ntop)
...
subroutine read_pot(fname,readpt)
         character*(*) fname
         logical :: readpt
         call ptr1sg (fname,readpt)
end subroutine read_pot


end module mod_ba1sg