...
use mod_hiblas, only: dscal, daxpy_wrapper, idamax
implicit double precision (a-h,o-z)
...
use mod_hiblas, only: daxpy_wrapper
implicit double precision (a-h,o-z)
...
implicit none
real(8), intent(inout) :: a(nmax*n)
integer, intent(in) :: n
integer, intent(in) :: nmax
integer icol, icolpt, irowpt, nrow
icolpt = 2
irowpt = nmax + 1
do 100 icol = 1, n - 1
!  icolpt points to first sub-diagonal element in column icol
