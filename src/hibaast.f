...
*  current revision date:  15-sep-2009 by pjd
*  latest revisions:  16-sep-2009 by mha
* --------------------------------------------------------------------
...
cstart unix-darwin .or. unix-86
        lwork = 144
        call dsyev('V','L',isize,e,narray,eig,work,lwork,ierr)
cend
cstart .not. unix-darwin .and. .not. unix-86
c;      write (6,1225)
...
135         format (5i4, a3, f10.3, 3x, 6f8.4/36x, 6f8.4)
     ...
     :        kp, ko, slab, ecm, (chold(isub + mm), mm=1,isize)
1351         format (5i4, a3, f10.3, 3x, 6f8.4)
          end if
        end if
*
...
320           format (4i4, f10.3, 3x, 6f8.4/29x, 6f8.4)
     ...
     :          (c(isub + mm), mm=1,isize)
3201          format (4i4, f10.3, 3x, 6f8.4)
            end if
          end if
330     continue
      end if
