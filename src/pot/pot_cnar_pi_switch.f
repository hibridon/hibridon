...
* JCP 128, 224309 (2008)
* in this version, use switching function to make repulsive wall the same
* as in original PESs, but make the well depth consistent with value
* deduced experimentally by Han et al.
* p. dagdigian - oct 2010
...
*
* addition by p. dagdigian - oct 2010
* scale potential with switching function
      sclfact = 1.76d0
      r12 = 6.5d0
      spread = 3.0d0
      sw = 1.d0 + 0.5d0*(sclfact - 1.d0) 
     $      *(1.d0 + tanh(spread*(r - r12)))
      call dscal(7,sw,xsum,1)
      vv0=xsum(1)
...
* scale difference potential also
      call dscal(5,sw,xdif,1)
