...
*
*  damp long-range part of PES to an isotropic C6 + C8 form, with
*  Cn coefficients determined from V00 term at R=15 and 20 bohr
*  (10-sep-2013, p.dagdigian)
...
*  convert from atomic units for printout
      econv=219474.6d0
      open (unit=12,file='vlms_arohx_v0aver_c6c8.txt')
      write(12,109)
109   format(' %R/bohr v00  v10  v20  v30  v40  v50  v60',
     :  '  v70  v80  v90  v10,0  v22  v32  v42  v52  v62',
     :  '  v72  v82  v92  v10,2')
      do i=1,40
        call pot(vv0,rr)
...
*
* switch to isotropic C6 + C8 potential at long range
* fit to isotropic part of potential at R=15 and 20
      c6sum = -1.0372175e+07*conv
      c8sum = -3.0086811e+08*conv
...
* isotropic term - merge with C6 + C8 form
      vv0 = (1.d0 - switch_lr)*vv0 
     :  + switch_lr*(c6sum/r**6 + c8sum/r**8)
      return
      end
*
