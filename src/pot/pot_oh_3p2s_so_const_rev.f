...
*
*   MODIFIED TO BE CONSISTENT WITH HIBA3P2S BASIS ROUTINE FOR PHOTODISSOCIATION
*   CALCULATIONS.  ONLY SPECIFY TWO S-O PARAMETERS apar AND aperp [vvl(5) and vvl(6)]
*  
*   written by p. dagdigian
*   current revision date:  13-feb-2015
*   REVISED 7-JAN-2019 (PJD)
*
...
*       STATEMENTS BELOW COMMENTED OUT ---
