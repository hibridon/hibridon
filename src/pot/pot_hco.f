...
*     convert from atomic units for printout
      write (6, 100) vv0*econv, (econv*vvl(i), i=1,15)
100   format(16(1pe16.8))
      goto 1
99    rr=3.0d0
      dr=0.2d0
...
109   format(' %R/bohr V0  V1  V2  V3  V4  V5  V6  V7  V8',
     +  '  V9  V10  V11  V12  V13  V14  V15')
      do i=1,250
        call pot(vv0,rr)
        write (12,110) rr,vv0*econv, (econv*vvl(j),j=1,15)
110     format(f7.2,16(1pe16.8))
        rr = rr + dr
      enddo
      close(12)
      end
