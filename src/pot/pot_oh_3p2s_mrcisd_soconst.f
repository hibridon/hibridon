...
*
*   modified so that so orbit paramters (apar and aperp) do not depend on R   
*  
*   written by p. dagdigian
*   current revision date:  8-oct-2019
*
...
* --------------------------------------------------------------------------
      ...
      potnam='O(3P)-H(2S) MRCI SO CONST'
      npot=1
      ibasty=23
      lammin(1)=1
      lammax(1)=18
...
99    rr=1.075d0
      dr=0.2d0
      open (unit=12,file='oh_vlms_mrcisd_so_const.txt')
      write(12,109)
