...
* Reference: Klos et al J. Chem. Phys. 112, 2195 (2000).
* NO is treated as closed shell in this routine
      ...
      potnam='Klos et al He-NO(Xclosed) CCSDT PES'
      print *, potnam
1      print *, ' r (bohr)'
      rshift=0.5
      xfact=0.8
...
* ------------------------------------------------------------------------
      ...
      include "common/parpot"
      potnam='Klos et al He-NO(closed shell) CCSDT PES'
...
* Revsed for closed shell NO : J. Klos 2003
* ----------------------------------------------------------------------
...
c      call dcopy(25,d2,1,aa,1)
c      call dqrank(aa,5,5,5,tol,kr,kpvt,qraux,work)
c      call dqrlss(aa,5,5,5,kr,vdif,xdif,rsd,kpvt,qraux)
c      call dscal(5,conv,xdif,1)
c      call dcopy(5,xdif,1,vvl(7),1)
      end
