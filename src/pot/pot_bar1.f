...
*               potential
      ...
      dimension rpaul(40),vpaul(40),tt(58),bb(58),work(350)
      data rpaul/
...
*  interpolate the  coefficients for the energies
          call bint4 (rpaul, vpaul, 40, ibcl,ibcr,dd,fbcr,kntopt,
     :                tt, bb,nc,kord, work)
        interp = 0
      endif
* here is  the entry point for subsequent entries into pot subroutine
* here to determine potential
      if (r .le. rpaul(2)) then
* here for exponential extrapolation at short range
        vv0=-3842.2+9262173/((r*.52917715)**12)
        vv0=vv0/219474.6
      else
* here for spline
        kord=4
