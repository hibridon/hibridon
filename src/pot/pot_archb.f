* System:  CH(B 2Sigma-)+Ar, original ab initio MRCI+Q PES's
...
* ------------------------------------------------------------------------
      ...
      potnam='ALEXANDER Ar-CH(B) avqz MRCI(D)'
      lammin(1)=1
      lammax(1)=6
      mproj(1)=0
      ntv(1)=1
...
*  Ar-CH(B) potential of Alexander
...
* latest revision date:  19-jan-1994
* ----------------------------------------------------------------------
