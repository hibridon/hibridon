...
*
*   INCLUDE ONLY VSUM AND VDIFF FOR SCATTERING WITHIN 2PI STATE
*
...
* --------------------------------------------------------------------------
      ...
      potnam='OH(X)-Kr Alexander-Klos MRCISDQ PESs'
      ibasty=3
      lammin(1)=1
      lammax(1)=12
      lammin(2)=2
...
*  ONLY PUT VSUM AND VDIF TERMS INTO VVL ARRAY
       call dcopy(12,vsum(2),1,vvl(1),1)
       call dcopy(6,vdif,1,vvl(13),1)
*       call dcopy(13,vsig,1,vvl(1),1)
*       call dcopy(13,vsum,1,vvl(14),1)
*       call dcopy(6,vdif,1,vvl(27),1)
*        scale V1 term with FC factors
*       call dscal(7,FCF(1),vsigpi,1)
*       call dcopy(7,vsigpi,1,vvl(33),1)     
*

*  WE NEED VV0, WHICH EQUALS VSUM(1)
      vv0 = vsum(1)/219474.6
*     vv0 term is a dummy
*      vv0 = 0.d0
