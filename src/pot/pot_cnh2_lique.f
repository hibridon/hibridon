c     ----------------------------------------------------------------- 
c     pot routine for the CN-H2 PES computed by Kalugina et al.,
c     jcp 139, 074301 (2013)
c
c     to be used with the 1Sigma-1Sigma or 2Sigma-1Sigma basis routine
c     data file used:  pot_cnh2_lique.dat
c
...
c     current revision:  8-jun-2017 (p. dagdigian)
c     ------------------------------------------------------------------
...
c     ----------------------------------------------------------------- 
c     loapot subroutine loads pot parameters for CN-H2 interaction
c     ----------------------------------------------------------------- 
