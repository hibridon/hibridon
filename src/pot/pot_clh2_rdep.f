...
* latest revision date:  31-may-2003
*    includes corrections of j. klos and g. groenenboem (2002)
* ----------------------------------------------------------------------
...
*  DO NOT include this (j. klos)
*       vxz(i)=sq2*vxz(i)
        vs(i)=0.5d0*(vxx(i)+vyy(i))
        vd(i)=0.5d0*(vyy(i)-vxx(i))
* reverse definition of difference potential (j. klos)
        vd(i)=-0.5d0*(vyy(i)-vxx(i))
200   continue
      sum=0
