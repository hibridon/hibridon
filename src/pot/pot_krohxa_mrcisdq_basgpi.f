...
*         for basgp1 basis routine
*
*   written by P.j.dagdigian (dec-2011)
*   modified by J. Klos (feb-2012) for MRCISD+Q PES
*   recent modification by J. Klos and P.J. Dagdigian
*   March 8 2012
*   V1 divided by sqrt(2) according to MHA and Corey 
*   JCP paper from 1986 (JCP 94, 100 1986) 
*   swapped sequence of V2 and V1 coefficients 
*   to match their order in the basgpi basis routine
      ...
      print *, potnam
*  consider only v=0  vib levels of 2pi state
      numvib = 1
      ivibpi(1)=0
      nterm=4 + 3*(numvib - 1)
...
* --------------------------------------------------------------------------
      ...
      common /covpot/ numvib,ivibpi(5)
      potnam='OH(A/X)-Kr Quenching MRCISDQ Klos PESs'
*      ibasty=19
      numvib=1
...
*  for first 2pi level
      ...
      lammax(4)=10
      mproj(4)=2
* jk just use ground v levels for Sigma and Pi
