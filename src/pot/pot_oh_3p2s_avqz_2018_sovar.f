...
*   this version has the option of allowing apar and aperp to vary with R
*  
*   written by p. dagdigian
*   current revision date:  9-oct-2019
*
...
* latest revision date:  9-oct-2019
* ----------------------------------------------------------------------
      implicit double precision (a-h,o-z)
      include "common/parbas"
      common /covvl/ vvl(8)
