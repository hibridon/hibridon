c     ----------------------------------------------------------------- 
c     pot routine for the  C2H-H2 PES computed by Dagdigian (2017)
c
c     points fit with LAmax = 14, LBmax = 6
c
c     to be used with the 2Sigma-1Sigma basis routine
c     data file used:  pot_c2hh2_12_6.dat
c
...
c     current revision:  29-aug-2017 (p. dagdigian)
c     ------------------------------------------------------------------
...
c
     ...
     $  xmconv=0.0005485799094979479d0, sq4pi=3.544907701811032d0)
      end module mod_c2hh2
c     ----------------------------------------------------------------- 
c     loapot subroutine loads pot parameters for C2H-H2 interaction
c     ----------------------------------------------------------------- 
...
C     the time.
      ...
      pot_name = 'DAGDIGIAN C2H-H2 RCCSD(T) PES'
...
C     Main program for makepot
      ...
      common /covvl/ vvl
      real(8), dimension(1) :: vvl
      character(40), parameter :: data_file_name='pot_c2hh2_14_6.dat'
      real(8) :: r, vv0
      integer :: i, nv, nlam
