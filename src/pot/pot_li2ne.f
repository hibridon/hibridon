...
* -----------------------------------------------------------------------
     ...
     :          work(1)
      ...
      data one /1.d0/
*  here are the diagonal matrix elements of (r-6.6) for v=7-11
      data rm66 /-.20997, -0.13786, -.06469, .008826, .08353/
*  here are the matrix elements of (r-re) for v=7-11
      data rmre/
     :   5.16733d-01,7.48218d-01,-9.54732d-02,1.81854d-02,-4.21810d-03,
     :   7.48218d-01,5.88839d-01,7.95886d-01,-1.06982d-01,2.13342d-02,
     :  -9.54732d-02,7.95886d-01,6.62010d-01,8.41376d-01,-1.18568d-01,
     :   1.81854d-02,-1.06982d-01,8.41376d-01,7.35526d-01,8.85037d-01,
     :  -4.21810d-02, 2.13342d-02,-1.18568d-01,8.85037d-01,8.10231d-01/
*  here are the matrix elements of (r-re)^2 for v=7-11
      data rmre2/
     :   1.32876, 6.89620d-01,5.09625d-01,-1.43894d-01,3.94493d-02,
     :   6.89620d-01,1.55914, 8.29898d-01,5.61451d-01,-1.67435d-01,
     :   5.09625d-01,8.29898d-01,1.80368, 9.80360d-01,6.11314d-01,
     :  -1.43894d-01,5.61451d-01,9.80360d-01,2.06180, 1.14093,
     :   3.94493d-02,-1.67435d-01,6.11314d-01,1.14093, 2.33513/
      izero=0
      kord=4
      if (rx .lt. rr(1)) then
...
*  ind1 is displacement of vibrational quantum number relative
*  to v=7 (ind1=1 if v=7, 2 if v=8, etc)
        ind1 = nvib-6
