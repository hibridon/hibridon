* System:  NP(X 1Sigma)+He, ab initio CCSD(T) PES's
* BASIS AVTZ+33221 
* Reference: 
* R. Tobola, J. Klos, F. Lique, G. Chalasinski, and M. H. Alexander 
* Astronomy & Astrophysics, 468 (3), 1123-1127 (2007)
*
*
...
c Jacobi coordinate
c ang : angle theta in degree
c R : distance between the center of mass of SO and He
c r_r : intermolecular distance
...
* ----------------------------------------------------------------------
      ...
      dimension 
     :          vsum(13),xsum(13),
     :          d0(169),aa(169),thta(13)
      dimension kpvt(14),qraux(13),work(200),rsd(13),re(26)
...
* convert to hartree
      conv=1.d0/219474.6
      call dscal(13,conv,xsum,1)
      vv0=xsum(1)
      call dcopy(12,xsum(2),1,vvl,1)
      end
...
c NOM DU FICHIER ICI ET NUMERO DU CANAL D'AFFICHAGE DES RESULTATS
        ...
        filnam="potdata/henp_fitmlv.dat"
