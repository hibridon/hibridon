...
* J. Chem. Phys. 106, 7637 (1997)
      ...
      potnam='FINK-STAEMMLER HePH(A) CEPA V00, V20, V22'
      econv=219474.6d0
1      print *, ' r (bohr)'
      rshift=0.5
      xfact=0.8
...
*    vvl(1-2) expansion coefficients in dl0 (l=1:2) of vsum
*             n.b. vvl(1) is zeroed out
*    vvl(3) expansion coefficients in d32 vdif

* uses linear least squares routines from cmlib

* author:  millard alexander
* latest revision date:  6-may-1996
* ----------------------------------------------------------------------
