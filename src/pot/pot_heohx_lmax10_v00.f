...
*
*  In this version, all terms, except for the isotropic term V00, are set to zero
*
...
c          rdif=5d0
c         endif
c CHANGE SIGN OF PHEOHD FOR CORRECT DEFINITION
...
* convert to hartree
      ...
      vv0=xsum(1)
*
* set anisotropic Vsum terms to Zero
*
      call dscal(11,0.d0,xsum,1)
*
*
...
*
* set Vdif terns equal to zero
*
      call dscal(9,0.d0,xdif,1)
*
*      call dscal(9,conv,xdif,1)
*
