...
*  current revision date: 15-mar-2019 
* by millard alexander, corrected av5z spin-orbit coupling
*    corrected sign of first pi coupling
c  -----------------------------------------------------------------
...
c H2sigm -i <^2\Sigma^-(xy),1/2|Hso|A^2\Sigma^+,1/2> from av5z calculations
      data h2sigm /
     + -1.6611d0, -2.1226d0, -1.8080d0, -1.4898d0, -1.0481d0,
     + -2.0775d-1, 1.2277d0, 3.2205d0, 5.8738d0, 9.2741d0, 1.0855d1,
     + 1.3451d1, 1.5792d1, 1.8252d1, 2.0778d1, 2.3310d1, 2.5787d1,
     + 2.8151d1, 3.2391d1, 3.5852d1, 3.8550d1, 4.0592d1, 4.2112d1,
     + 4.4056d1, 4.5110d1, 4.5667d1, 4.5962d1, 4.6115d1, 4.6191d1,
     + 4.6229d1, 4.6260d1, 4.6272d1, 4.6273d1, 4.6270d1, 4.6269d1,
     + 4.6270d1, 4.6272d1, 4.6273d1, 4.6273d1/
c H4sigm -i <^4\Sigma^-(xy),1/2|Hso|A^2\Sigma^+,1/2> from av5z calculations
      data h4sigm /
     + -7.5630d-1, -4.7817d-1, -5.9655d-1, -6.5352d-1, -5.0266d-1,
     + 2.1233d-1, 1.7332d0, 4.1978d0, 7.8002d0, 1.2578d1, 1.4822d1,
     + 1.8521d1, 2.1866d1, 2.5385d1, 2.9002d1, 3.2627d1, 3.6175d1,
     + 3.9562d1, 4.5635d1, 5.0588d1, 5.4444d1, 5.7361d1, 5.9528d1,
     + 6.2296d1, 6.3791d1, 6.4581d1, 6.5000d1, 6.5215d1, 6.5323d1,
     + 6.5376d1, 6.5420d1, 6.5438d1, 6.5439d1, 6.5434d1, 6.5434d1,
     + 6.5435d1, 6.5437d1, 6.5439d1, 6.5439d1/
...
* HERE WE HAVE CHANGED THE SIGN OF THE SPIN-COUPLED TERMS 5,1 AND 10,2  15-mar-2019
      data cpi /
...
*      data for OH A2sig+ state vibrational wavefunctions dawes calculation
     ...
     + psiv_4(157), psiv_5(157), psiv_6(157), psiv_7(157),
     + psiv_8(157), psiv_9(157)
* knots for spline interpolation of vibrational wavefunctions psi(v=0:9) in A state
      data rpsi /
...
* from numerov calculations an a grid of r=[0.9:0.005:10], then thinned to the rpsi grid
      data psiv_0/
...
* note that psiv_9 is not quite normalized over this range (overlap integral is 0.99951)1
      data psiv_9 /
     : 3.9991d-5, 1.2777d-4, 3.7511d-4, 1.0146d-3, 2.5356d-3,
     : 5.8760d-3, 1.2652d-2, 2.5339d-2, 4.7243d-2, 8.2116d-2,
     : 1.3317d-1, 2.0128d-1, 2.8288d-1, 3.6843d-1, 4.4246d-1,
     : 4.8503d-1, 4.7593d-1, 4.0157d-1, 2.6188d-1, 7.4077d-2,
     : -1.2833d-1, -3.0166d-1, -4.0338d-1, -4.0532d-1, -3.0339d-1,
     : -1.2141d-1, 9.3242d-2, 2.8231d-1, 3.9369d-1, 3.9629d-1,
     : 2.8910d-1, 1.0170d-1, -1.1391d-1, -2.9830d-1, -4.0172d-1,
     : -3.9749d-1, -2.8817d-1, -1.0377d-1, 1.0729d-1, 2.9172d-1,
     : 4.0495d-1, 4.2149d-1, 3.3975d-1, 1.8078d-1, -1.8293d-2,
     : -2.1366d-1, -3.6477d-1, -4.4250d-1, -4.3398d-1, -3.4361d-1,
     : -1.9058d-1, -3.9082d-3, 1.8363d-1, 3.4151d-1, 4.4619d-1,
     : 4.8405d-1, 4.5234d-1, 3.5832d-1, 2.1700d-1, 4.8230d-2,
     : -1.2650d-1, -2.8691d-1, -4.1620d-1, -5.0243d-1, -5.3925d-1,
     : -5.2570d-1, -4.6556d-1, -3.6632d-1, -2.3794d-1, -9.1643d-2,
     : 6.1238d-2, 2.1014d-1, 3.4596d-1, 4.6146d-1, 5.5146d-1,
     : 6.1286d-1, 6.4444d-1, 6.4665d-1, 6.2129d-1, 5.7118d-1,
     : 4.9983d-1, 4.1114d-1, 3.0916d-1, 1.9788d-1, 8.1051d-2,
     : -3.7909d-2, -1.5600d-1, -2.7067d-1, -3.7983d-1, -4.8185d-1,
     : -5.7550d-1, -6.5995d-1, -7.3471d-1, -7.9958d-1, -8.5458d-1,
     : -8.9996d-1, -9.3610d-1, -9.6352d-1, -9.8280d-1, -9.9459d-1,
     : -9.9956d-1, -9.9840d-1, -9.9180d-1, -9.8040d-1, -9.6485d-1,
     : -9.4575d-1, -9.2365d-1, -8.9907d-1, -8.7250d-1, -8.4435d-1,
     : -8.1502d-1, -7.8486d-1, -7.5417d-1, -7.2321d-1, -6.9223d-1,
     : -6.6143d-1, -6.3098d-1, -6.0102d-1, -5.7169d-1, -5.4307d-1,
     : -5.1525d-1, -4.8830d-1, -4.6226d-1, -4.3716d-1, -4.1303d-1,
     : -3.8989d-1, -3.6773d-1, -3.4655d-1, -3.2635d-1, -3.0711d-1,
     : -2.8881d-1, -2.7142d-1, -2.5493d-1, -2.3931d-1, -2.2452d-1,
     : -2.1053d-1, -1.9732d-1, -1.8485d-1, -1.7310d-1, -1.6202d-1,
     : -1.5159d-1, -1.4178d-1, -1.3255d-1, -1.2389d-1, -1.1575d-1,
     : -1.0811d-1, -1.0094d-1, -9.4220d-2, -8.7923d-2, -8.2025d-2,
     : -7.6503d-2, -7.1335d-2, -6.6501d-2, -6.1980d-2, -5.7754d-2,
     : -5.3804d-2, -5.0115d-2/
      end
