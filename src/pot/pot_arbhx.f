* System:  BH(X 1Sigma+)+Ar, original ab initio MRCI+Q PES's
...
* ------------------------------------------------------------------------
      ...
      potnam='ALEXANDER Ar-BH(X) avtz MRCI(D)'
      lammin(1)=1
      lammax(1)=6
      mproj(1)=0
      ntv(1)=1
...
*  Ar-BH(X) potential of Alexander
...
* latest revision date:  9-oct-1993
* ----------------------------------------------------------------------
