C     ------------------------------------------------------------------
C     Pot routine for OD--H2 PES, translormfed from the 2013 Ma, Dagdigian, 
c     Klos, and Alexander ab initio OH--H2 PES at MRCI/aug-cc-pVQZ level.
C     
C     Author: Qianli Ma
c     Revised by P. Dagdigian (29-sep-2020)
C     
C     To be used in combination of the 2Pi--1Sigma basis.
C     
C     Data file used: pot_odh2_tranformed.dat
C     ------------------------------------------------------------------
...
C     
      pot_name = 'OD--H2 MRCI PES transformed'
