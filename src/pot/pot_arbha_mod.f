* System:  BH(X 1Sigma+)+Ar, modified MRCI+Q PES's
...
*  Ar-BH(X) potentials of alexander deepened and shifted
...
* re's for ab initio potentials
      data re /
     : 8.1189d0, 8.2003d0, 8.6931d0, 8.6823d0, 8.0992d0, 7.9400d0,
     : 8.0930d0,8.1357d0, 7.7669d0, 6.9859d0, 6.2411d0, 7.1017d0,
     : 7.8866d0, 8.1264d0/
...
* for long range damp out difference potential
          ...
          if (r .gt. rmax) then
            damp=-half*(tanh(1.d0*(r-rmax-5))-one)
