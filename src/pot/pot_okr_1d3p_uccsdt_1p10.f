...
*  Multiplied 1Sigma+ curve by 1.10 (10% increase in depth)
...
99    rr=2.6d0
      dr=0.25d0
      open (unit=12,file='okr_uccsdt_1p10_vlms.txt')
      open (unit=13,file='okr_uccsdt_1p10_pots_so.txt')
      write(12,109)
