...
* --------------------------------------------------------------------------
      ...
      potnam='REFIT CN(X)-AR PES of UDO'

********************      ibasty=4
      ibasty=2
*** THIS IS CHANGED TO ONE
      ibasty=1
      lammin(1)=1
      lammax(1)=6
      mproj(1)=0
...
*  by rows: lam1 lam2 r0 c1 c2 c3 cl
     ...
     : -7.5859233d3, -1.6775191d2/
      data vsigc2/
     : 0.8121d0, 0.8184d0, 0.8283d0, 0.8337d0, 0.8520d0, 0.8644d0,
     : 0.8674d0/
      data vsigc3/
     : 7.609d0, 7.415d0, 7.097d0, 7.011d0, 7.251d0, 7.721d0, 7.949d0/
      data vsigcl/
     : 131.93d0, 136.69d0, 137.24d0, 129.11d0, 126.72d0, 117.06d0,
     : 112.29d0/
