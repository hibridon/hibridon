c     pot routine for the interaction of ND2 with H2
...
c     current revision:  23-apr-2020 (p. dagdigian)
c     ------------------------------------------------------------------
...
C     the time.
      ...
      pot_name = 'ND2-H2 PES, from A. Faure'
...
C     Main program for makepot
      ...
      common /covvl/ vvl
      real(8), dimension(1) :: vvl
      character(40), parameter :: data_file_name='pot_nd2h2.dat'
      real(8) :: r, vv0
      integer :: i, nv, nlam
