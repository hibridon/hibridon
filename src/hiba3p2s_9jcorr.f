...
* 
****** 
*  IN THIS VERSION,THE V2 MATRIX ELEMENTS ARE MULTIPLED BY -1 IF ABS(J12-J12P)
*  EQUALS -1 TO MAKE THE SIGNS THE SAME AS IN MHA'S BASIS ROUTINE
******
*
...
*  current revision date:  18-feb-2019 by p.dagdigian
* --------------------------------------------------------------------
...
60    vee = 0.d0
*
*  change sign of matrix element if abs(j12 - j12p) equals -1
1000  if (abs(j12_1 - j12_2) .eq. 1) vee = -vee
      goto 2000
2000  return
      end
* ------------------------------eof-----------------------------------
