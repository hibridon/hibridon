...
write (6,*) 'dg1(1)=', dg1%get_element(int(1,8))
write (6,*) 'dg1(2)=', dg1%get_element(int(2, 8))
write (6,*) 'dg1(1024)=', dg1%get_element(int(1024,8))
write (6,*) 'dg1(1024*1024+1)=', dg1%get_element(int(1024,8)*1024+1)
ig1 = igrovec_type(block_size=1024, num_blocks=16)
call ig1%append(42)
write (6,*) 'ig1(1)=', ig1%get_element(int(1,8))
call ig1%empty()
call ig1%append(666)
write (6,*) 'ig1(1)=', ig1%get_element(int(1, 8))
