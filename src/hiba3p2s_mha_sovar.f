...
*  tshre parameters apar and aperp are assumed to depend upon R.
*
...
*            lb=7:  apar spin-orbit matrix element for R=inf
*            lb=8:  aperp spin-orbit matrix element for R=inf
*
...
*
      ...
      vee32 = 0.d0
      vee52 = 0.d0
      goto (10,20,30,40,50,60,70,80),lb
      goto 1500
*
...
50    sign = 1.d0
51    if (ist1 .eq. 1 .and. ist2 .eq. 1) vee52 = - 0.5d0
...
60    sign = 1.d0
61    if (ist1 .eq. 1 .and. ist2 .eq. 1) vee32 = - 4.d0 / 10.d0
      if ((ist1 .eq. 1 .and. ist2 .eq. 2) .or.
     +  (ist1 .eq. 2 .and. ist2 .eq. 1)) vee32 = 1.d0 / 5.d0
     ...
     +  (ist1 .eq. 4 .and. ist2 .eq. 3)) vee12 = 1.0 / sqrt(18.d0)
      ...
      goto 1000
*
*  apar spin-orbit matrix element for R=inf
70    sign = -1.d0
      goto 51
*
*  aperp spin-orbit matrix element
