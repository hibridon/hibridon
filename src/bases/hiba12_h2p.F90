...
320 continue
if ( i.gt. nv2max) then
  write (6, 350) v2_index, nv2max
  write (9, 350) v2_index, nv2max
...
if (clist) then
  write (6, 360) v2_index
  write (9, 360) v2_index
